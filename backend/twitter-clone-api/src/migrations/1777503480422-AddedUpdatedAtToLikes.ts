...
export class AddedUpdatedAtToLikes1777503480422 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "likes" DROP CONSTRAINT "UQ_likes_userId_postId"`);
        await queryRunner.query(`ALTER TABLE "likes" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "UQ_likes_userId_postId" UNIQUE ("userId", "postId")`);
    }
